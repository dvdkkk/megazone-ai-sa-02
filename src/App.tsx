...
const coursesData: CourseTrack[] = [
  {
    ...
    detailUrl: 'https://megazone-ai-sa-01.vercel.app'
  },
  {
    id: 'architect',
    trackCode: 'TRACK 02',
    ...
    detailUrl: 'https://megazone-ai-sa-02.vercel.app'
  },
  {
    id: 'security',
    trackCode: 'TRACK 03',
    ...
    detailUrl: 'https://megazone-ai-sa-03.vercel.app'
  },
  {
    id: 'data',
    trackCode: 'TRACK 04',
    ...
    detailUrl: 'https://megazone-ai-sa-04.vercel.app'
  }
];
...
const regCourseSteps: CurriculumStep[] = [
  {
    stepNum: 1,
    title: '생성형 AI & 프롬프트 기초',
    icon: <BookOpen size={24} />,
    items: [
      '생성형 AI 트렌드와 LLM 핵심 원리 이해',
      'AIR Studio 및 Gemini API 활용 실습',
      'Zero-shot · CoT · 메타 프롬프팅 설계'
    ]
  },
  {
    stepNum: 2,
  ...
  },
  {
    ...
    icon: <Target size={24} />,
    items: [
      '아이디어를 서비스로 구현하는 MVP 프로젝트',
      'AI를 활용한 기획 · 개발 · 테스트 자동화',
      '실행 가능한 프로토타입 제작 및 발표'
    ]
  },
  {
    stepNum: 4,
    title: 'AI-Ready 네트워크 인프라',
    icon: <Building2 size={24} />,
    items: [
      'TCP/IP 프로토콜과 네트워크 기본 구조',
      'LAN · Trunk · L3 라우팅 · NAT 구성',
      'ACL 기반 네트워크 접근 제어'
    ]
  },
  {
    stepNum: 5,
    title: 'AI-Ready 리눅스 인프라',
    icon: <Monitor size={24} />,
    items: [
      '리눅스 파일 시스템 및 사용자 권한 관리',
      '셸 스크립트를 활용한 운영 자동화',
      'NVIDIA GPU 드라이버와 CUDA 환경 구성'
    ]
  },
  {
    stepNum: 6,
    title: 'Python 기반 LLM 서비스',
    icon: <Layers size={24} />,
    items: [
      'Conda 기반 Python 가상환경 구축',
      'Hugging Face 모델 로드 및 Ollama 설치',
      '모델 양자화와 FastAPI 서버 구축'
    ]
  },
  {
    stepNum: 7,
    ...
    items: [
      'Docker 이미지 최적화 및 컨테이너 운영',
      'Kubernetes 클러스터 구축과 관리',
      'Pod · Deployment · Service 아키텍처 구성'
    ]
  },
  {
    stepNum: 8,
    title: 'AI 데이터 아키텍처 & RAG',
    icon: <Building size={24} />,
    items: [
      'MySQL 기반 데이터 모델링과 DB 구축',
      'Vector DB와 pgvector 기반 임베딩 저장',
      'FastAPI · RAG 파이프라인 구현'
    ]
  },
  {
    stepNum: 9,
    ...
    icon: <Cloud size={24} />,
    items: [
      'AWS VPC 네트워크 및 보안 구조 설계',
      'EC2 · S3 · RDS 기반 클라우드 아키텍처 구축',
      '고가용성과 로드밸런싱 환경 구성'
    ]
  },
  {
    stepNum: 10,
    title: 'AWS AI Cloud Operations',
    icon: <Bot size={24} />,
    items: [
      'AWS GPU 인스턴스 기반 AI 모델 운영',
      'SageMaker Studio 기반 모델 학습 및 배포',
      'EFS를 활용한 대용량 모델 스토리지 구성'
    ]
  },
  {
    stepNum: 11,
    title: 'Terraform & CI/CD 자동화',
    icon: <Compass size={24} />,
    items: [
      'Terraform HCL 기반 AWS 인프라 구축',
      'GitLab CI/CD 파이프라인 설계',
...
const projCourseSteps: CurriculumStep[] = [
  {
    stepNum: 12,
    title: 'AI Cloud 실전 프로젝트',
    icon: <Briefcase size={24} />,
    items: [
      '금융·공공기관용 폐쇄형 AI 검색 시스템',
      '글로벌 쇼핑몰 대규모 트래픽 대응 AI 추천 시스템',
      '스마트 팩토리 에지 컴퓨팅 · SaaS형 AI 문서 요약·번역 플랫폼'
    ]
  },
  {
    stepNum: 13,
    ...
    icon: <Award size={24} />,
    items: [
      'AI 클라우드 프로젝트 포트폴리오 완성',
      '직무 특강 · 취업 상담 · 기술 면접 대비',
      '프로젝트 성과 발표 및 우수 수료생 시상'
    ]
  }
];
...
export default function App() {
  ...
  const handleFormSubmit = (e: React.FormEvent) => {
    ...
    try {
      ...
      payload.append('_form_id', '513577b3eccb06d86677eea25da57622');
      ...
      <header className="header" id="header">
        <div className="header-inner">
          <div className="header-left">
            <a href="https://megazone-ai-sa.vercel.app" className="logo-wrap" id="headerLogoLink">
              <img
            ...
            <nav className="gnb-nav">
              <a href="https://megazone-ai-sa-01.vercel.app">AI 에이전트</a>
              <a href="https://megazone-ai-sa-02.vercel.app">AI 아키텍트</a>
              <a href="https://megazone-ai-sa-03.vercel.app">AI 보안</a>
              <a href="https://megazone-ai-sa-04.vercel.app">AI 데이터</a>
              <a href="#faq">FAQ</a>
            </nav>
          </div>
        ...
        <div className={`mobile-drawer ${mobileMenuOpen ? 'open' : ''}`} id="mobileDrawer">
          <a href="https://megazone-ai-sa-01.vercel.app" onClick={() => setMobileMenuOpen(false)}>AI 에이전트</a>
          <a href="https://megazone-ai-sa-02.vercel.app" onClick={() => setMobileMenuOpen(false)}>AI 아키텍트</a>
          <a href="https://megazone-ai-sa-03.vercel.app" onClick={() => setMobileMenuOpen(false)}>AI 보안</a>
          <a href="https://megazone-ai-sa-04.vercel.app" onClick={() => setMobileMenuOpen(false)}>AI 데이터</a>
      ...
      <section className="hero-section" id="hero">
        ...
        <div className="container">
          ...
          <p className="hero-desc text-slate-300 max-w-3xl mx-auto mb-8 text-base md:text-lg leading-relaxed">
            리눅스 기초부터 생성형 AI 서비스 운영까지 아우르는 AI 인프라 전문가를 양성합니다. GPU 컨테이너 환경, 벡터 DB·AWS 아키텍처 설계, 인프라 자동화(IaC)까지 실무 MLOps 핵심 역량을 습득합니다.
          </p>
          ...
          <div className="track-cards-grid" id="trackCardsGrid">
            <div className="ncloud-card card-cyan reveal-item reveal-delay-1">
              <div>
                ...
                <h3 className="card-title">모든 AI는 인프라 위에서 돌아갑니다</h3>
                <p className="card-text">
                  생성형 AI 도입이 늘수록 GPU 인프라·클라우드 아키텍처를 다루는 엔지니어 수요가 함께 커지고 있습니다.
                </p>
              </div>
            </div>
            ...
            <div className="ncloud-card card-navy reveal-item reveal-delay-2">
              <div>
                ...
                <h3 className="card-title">클라우드 경험은 IT 채용의 기본기</h3>
                <p className="card-text">
                  AWS·Kubernetes 실무 경험이 인프라·백엔드·MLOps 채용 공고의 핵심 요구사항으로 자리 잡았습니다.
                </p>
              </div>
            </div>
            ...
            <div className="ncloud-card card-purple reveal-item reveal-delay-3">
              <div>
                ...
                <h3 className="card-title">MLOps는 이제 시작</h3>
                <p className="card-text">
                  AI 서비스 운영(MLOps) 직무는 공급이 수요를 따라가지 못하는 대표적 영역입니다. 지금 시작하면 선점할 수 있습니다.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container">
          ...
          <div className="why-megazone-grid">
            <div className="why-megazone-card reveal-item reveal-delay-1">
              ...
              <div className="why-card-sub">기초부터 GPU 인프라까지</div>
              <p className="why-card-desc">
                네트워크·리눅스 기초에서 NVIDIA GPU·CUDA 환경 구성까지 단계별로 완주합니다.
              </p>
            </div>

            <div className="why-megazone-card reveal-item reveal-delay-2">
              <div className="why-card-title">02</div>
              <div className="why-card-sub">실전 클라우드 아키텍처</div>
              <p className="why-card-desc">
                Kubernetes 클러스터와 AWS VPC·EC2·S3 기반 고가용성 아키텍처를 직접 설계합니다.
              </p>
            </div>

            <div className="why-megazone-card reveal-item reveal-delay-3">
              <div className="why-card-title">03</div>
              <div className="why-card-sub">인프라 자동화(IaC)</div>
              <p className="why-card-desc">
                Terraform과 GitLab CI/CD로 인프라 구축·배포를 코드로 자동화합니다.
              </p>
            </div>

            <div className="why-megazone-card reveal-item reveal-delay-4">
              <div className="why-card-title">04</div>
              <div className="why-card-sub">현업 시나리오 프로젝트</div>
              <p className="why-card-desc">
                금융·공공 폐쇄형 AI 검색, 대규모 트래픽 추천 시스템 등 실전 주제로 프로젝트를 수행합니다.
              </p>
            </div>
          </div>
        </div>
